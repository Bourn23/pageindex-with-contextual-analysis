...
def main():
    ...
    parser.add_argument('md_file', type=Path, help='Path to the folder containing the markdown file')
    ...
    if not doi:
        print(f"Error: Could not determine DOI for {args.md_file}. Please provide it manually with --doi.")
        return
    ...
    try:
        ...
        subprocess.run([
            "python", "advanced_evaluation_with_metric.py", 
            "-gt", args.dataset, 
            "-i", doi, 
