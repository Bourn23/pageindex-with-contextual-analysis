...
async def process_table_node(client, model, table_data: dict, max_retries: int = 3, paper_context: dict = None):
    ...
    **IMPORTANT INSTRUCTIONS for complex tables:**
    ...
    7. If paper context is provided above, use it to fill in the processing_method field for each 
       measurement if you can match the sample to a described synthesis procedure.
...
def main():
    ...
    # Save
    out_path = args.markdown_file.parent / "robust_results_v7.json"
    output_data = {
